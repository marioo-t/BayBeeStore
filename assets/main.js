...
// ======================
// MÉTODOS DE PAGO Y REDES SOCIALES EN EL FOOTER
// ======================
    ...
    document.querySelectorAll('footer').forEach(footer => {
        footer.insertAdjacentHTML('beforeend', `
            ...
            <div class="flex justify-center gap-4 mt-6 px-4">
                <!-- PLACEHOLDER PARA LOGO DE FACEBOOK - Reemplaza el src con tu link cuando lo tengas -->
                <a href="images/Facebook_Logo.png" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brandYellow transition-colors" aria-label="Facebook">
                    <!-- Temporalmente usando emoji, reemplaza con tu imagen -->
                    <span class="text-xl">f</span>
                    <!-- Cuando tengas el link de Facebook, usa esto:
                    <img src="https://www.facebook.com/profile.php?id=61575093534363" alt="Facebook" class="w-6 h-6" />
                    -->
                </a>
                <a href="#" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brandYellow transition-colors" aria-label="Instagram">
                    <span class="text-xl">📷</span>
                </a>
                <a href="#" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brandYellow transition-colors" aria-label="Twitter">
                    <span class="text-xl">🐦</span>
                </a>
            </div>
        `);
